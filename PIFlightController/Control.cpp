...
void Control::MapMotorOutput(double pitchControl,double rollControl, double yawControl, double throttleBaseline){
    ...
    double yawN = 1 - yawP;
    double XPSpeed = throttleBaseline * pitchP * rollN *yawP;
    double XNSpeed = throttleBaseline * pitchP * rollP *yawN;
    double YPSpeed = throttleBaseline * pitchN * rollN *yawN;
    double YNSpeed = throttleBaseline * pitchN * rollP *yawP;
